...
import java.util.*;
import com.whut.classes.User;
import com.whut.classes.Browser;
import com.whut.classes.Administratior;
import com.whut.classes.Operator;
...
public  class DataProcessing {
	...
	static {
		...
		users.put("kate", new Administratior("kate","123","administrator"));
	}
	...
	public static boolean update(String name, String password, String role){
		...
		if (users.containsKey(name)) {
			if (role.equalsIgnoreCase("administrator"))
				user = new Administratior(name,password, role);
